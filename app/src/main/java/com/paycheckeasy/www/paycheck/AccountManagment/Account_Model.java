...
//    private String Data_Key;
    ...
    private String Card_Name, First_Num, Last_Num, Holder_Name, Expiry_Date, Type, Amount, Remark;
    private Object Created_TimeStamp, Last_TimeStamp;


    public Account_Model(){
        this.Last_TimeStamp = ServerValue.TIMESTAMP;
    }

    // For Cash
	public Account_Model(int Color_Code, String Card_Name, String Type, String Amount, String Remark){

        this.Created_TimeStamp = ServerValue.TIMESTAMP;
